...
public interface RestauranteRepository extends JpaRepository<Restaurante, Integer> {
    ...
    @Query(value ="select r.idrestaurante, r.nombre, r.foto, r.fotocontenttype, r.fotonombre \n" +
            ...
            "            left join (\n" +
            "            select  r.idrestaurante, avg(p.precio) as `prom_prec`  from plato p\n" +
            "                        left join restaurante r\n" +
            ...
            "having  t3.`idcategorias` like %?6% \n" +
            "                        or t3.`idcategorias` like %?7 \n" +
            "                        or t3.`idcategorias` like ?8% order by r.iddistrito = ?9 DESC ", nativeQuery = true)
    Page<RestauranteDTO> listaRestaurante(String texto, Integer limitInfP, Integer limitSupP,Integer limitInfVal, Integer limitSupVal, String id1,String id2, String id3,Integer iddistrito, Pageable pageable);
...
/*
    @Query(value ="select r.idrestaurante, r.nombre, r.foto, r.fotocontenttype, r.fotonombre ,r.estado as estado\n" +
            ...
            "and (preciopromedio > ?2 and preciopromedio <= ?3) \n" +
    ...
    Page<RestauranteDTO> listaRestaurante2(String texto, Integer limitInfP, Integer limitSupP, String id1,String id2, String id3,Integer limitInfVal, Integer limitSupVal,Integer iddistrito, Pageable pageable);
